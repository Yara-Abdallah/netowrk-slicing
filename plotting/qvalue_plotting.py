...
filename1  = "C://Users//Windows dunya//Downloads//action_masking_occ_wasting_req_period3_phase1//qvalue_decentralized_for_plotting//qvalue0.pkl"
# filename2 = "C://Users//Windows dunya//Downloads//action_masking_occ_wasting_req_period3_phase2//qvalue_decentralized_for_plotting//qvalue0.pkl"
# filename3 = "C://Users//Windows dunya//Downloads//action_masking_occ_wasting_req_period3_phase3//qvalue_decentralized_for_plotting//qvalue0.pkl"
# filename4 = "C://Users//Windows dunya//Downloads//action_masking_occ_wasting_req_period3_phase4//qvalue_decentralized_for_plotting//qvalue0.pkl"
...
plt.plot(x_values, result, label=f'wifi_qvalue')
plt.xlabel('episode')
plt.ylabel('wifi_qvalue')
plt.legend()
plt.title(f'Rolling Average Plot (window={window_size})')
plt.grid(True)
plt.savefig('wifi_qvalue.svg', format='svg')
