...
filename1  = "C://Users//Windows dunya//Downloads//action_masking_occ_wasting_req_period3_phase1//utility_decentralized//utility0.pkl"
# filename2 = "C://Users//Windows dunya//Downloads//action_masking_occ_wasting_req_period3_phase2//utility_decentralized//utility0.pkl"
# filename3 = "C://Users//Windows dunya//Downloads//action_masking_occ_wasting_req_period3_phase3//utility_decentralized//utility0.pkl"
# filename4 = "C://Users//Windows dunya//Downloads//action_masking_occ_wasting_req_period3_phase4//utility_decentralized//utility0.pkl"
...
plt.plot(x_values, result, label=f'wifi_serving_ratio')
plt.xlabel('steps')
plt.ylabel('wifi_serving_ratio')
plt.legend()
plt.title(f'Rolling Average Plot (window={window_size})')
plt.grid(True)
plt.savefig('wifi_serving_ratio.svg', format='svg')
