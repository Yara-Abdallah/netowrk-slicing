...
filename  = "C://Users//Windows dunya//Downloads//action_masking_occ_wasting_req_period3_phase1//qvalue_decentralized_for_plotting//qvalue1.pkl"
...
plt.plot(x_values, result, label=f'3G_qvalue')
plt.xlabel('episode')
plt.ylabel('3G_qvalue')
plt.legend()
plt.title(f'Rolling Average Plot (window={window_size})')
plt.grid(True)
plt.savefig('3G_qvalue.svg', format='svg')
