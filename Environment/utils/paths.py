...
results_dir = os.path.join(sys.path[0],
                           'action_masking_occ_wasting_req_period3_phase4')
...
prev_results_dec_weight = "//content//drive//MyDrive//network_slicing//action_masking_occ_wasting_req_period3_phase3"
prev_results_dec_memory = "//content//drive//MyDrive//network_slicing//action_masking_occ_wasting_req_period3_phase3"
