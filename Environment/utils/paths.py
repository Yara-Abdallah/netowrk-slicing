...
results_dir = os.path.join(sys.path[0], 'decentralize_action_masking_throughput_cost_phase2')
...
prev_results_dec_weight = "/content/drive/MyDrive/network_slicing/decentralize_action_masking_throughput_cost_phase1"
prev_results_dec_memory = "/content/drive/MyDrive/network_slicing/decentralize_action_masking_throughput_cost_phase1"
