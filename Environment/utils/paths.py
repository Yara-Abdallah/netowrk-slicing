...
results_dir = os.path.join(sys.path[0],
                           'decentralize_action_masking_occupancy_wasting_requests_period3_phase3_more_explore')
...
prev_results_dec_weight = "/content/drive/MyDrive/network_slicing/decentralize_action_masking_occupancy_wasting_requests_period3_phase2_more_explore"
prev_results_dec_memory = "/content/drive/MyDrive/network_slicing/decentralize_action_masking_occupancy_wasting_requests_period3_phase2_more_explore"
