...
results_dir = os.path.join(sys.path[0], 'decentralize_action_masking_last_scenario')
...
# prev_results_dec_weight = "/content/drive/MyDrive/network_slicing/dec_action_masking_phase1"
# prev_results_dec_memory = "/content/drive/MyDrive/network_slicing/dec_action_masking_phase1"
