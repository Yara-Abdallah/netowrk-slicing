...
results_dir = os.path.join(sys.path[0],
                           'action_masking_period3_phase2_docc_westing_req')
...
prev_results_dec_weight = "//content//drive//MyDrive//network_slicing//action_masking_period3_phase1_docc_westing_req"
