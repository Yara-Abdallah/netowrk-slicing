...
results_dir = os.path.join(sys.path[0],
                           'action_masking_period3_phase3_derivation_occ_westing_req')
...
prev_results_dec_weight = "//content//drive//MyDrive//network_slicing//action_masking_period3_phase2_derivation_occ_westing_req"
prev_results_dec_memory = "//content//drive//MyDrive//network_slicing//action_masking_period3_phase2_derivation_occ_westing_req"
