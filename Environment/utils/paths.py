...
results_dir = os.path.join(sys.path[0],
                           'decentralize_action_masking_occupancy_wasting_requests_with_derivations_period2_phase3')
...
prev_results_dec_weight = "/content/drive/MyDrive/network_slicing/decentralize_action_masking_occupancy_wasting_requests_with_derivations_period2_phase2"
prev_results_dec_memory = "/content/drive/MyDrive/network_slicing/decentralize_action_masking_occupancy_wasting_requests_with_derivations_period2_phase2"
